        ...
        <section class="store-heading">
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-2" data-aos="zoom-in">               
                <div class="form-group">
                  <label for="postalCode">Stok</label>
                  <input
                    type="number"
                    class="form-control"
                    id="stock"
              ...
              <div class="col-lg-2" data-aos="zoom-in">    
                ...
                <label for=""></label>
                  <button
                    type="submit"
                    class="btn btn-primary px-4 text-white btn-block mt-2"
                  >
                    Add to Cart
                  </button>
                @else
                ...
                @endauth
                {{--  <a class="btn btn-primary nav-link px-4 text-white btn-block mt-4 mb-3"href="cart.html">
                  Add to Cart
                </a>  --}}
                </div>
              </div>
