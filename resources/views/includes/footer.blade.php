<section class="h-100 w-100 bg-white" style="box-sizing: border-box">
    <style>
      ...
      @media (min-width: 576px) {
        .footer-2-1 {
          background-image: url('http://api.elements.buildwithangga.com/storage/files/2/assets/Footer/Footer3/Footer-3-2.png');
          ...
          <div class="col-lg-3 col-md-6">
            <div class="">
              <div class="list-space">
                <img src="/images/logo-dashboard.png" alt=""  width="80px"/>
              </div>
      ...
      <div class="border-color info-footer">
        ...
        <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
          <div class="d-flex title-font font-medium align-items-center gap-4">
            <a href="">
              <svg class="social-media-c mr-4 ml-4" width="30" height="30" viewBox="0 0 30 30" fill="none"
            ...
            <a href="">
              <svg class="social-media-c mr-4" width="30" height="30" viewBox="0 0 30 30" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="15" cy="15" r="15" fill="#C7C7C7" />
                <g clip-path="url(#clip0)">
                  <path
            ...
            <a href="">
              <svg class="social-media-p mr-4" width="30" height="30" viewBox="0 0 30 30" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <nav class="mx-auto d-flex flex-wrap align-items-center justify-content-center gap-4 mt-2">
            <a href="" class="footer-link mr-4" style="text-decoration: none">Terms of Service</a>
            <span>|</span>
            <a href="" class="footer-link mr-4 ml-4" style="text-decoration: none">Privacy Policy</a>
            <span>|</span>
            <a href="" class="footer-link mr-4 ml-4" style="text-decoration: none">Licenses</a>
          </nav>
          <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center mt-2">
